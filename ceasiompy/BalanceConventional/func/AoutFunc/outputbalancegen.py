...
def output_txt(out, mw, bi, NAME):
    ...
    OutputTextFile.write('\nRoll moment, Ixx [kgm^2]: '\
                         + str(int(round(out.Ixx_lump))))
    OutputTextFile.write('\nPitch moment, Iyy [kgm^2]: '\
                         + str(int(round(out.Iyy_lump))))
    OutputTextFile.write('\nYaw moment, Izz [kgm^2]: '\
                         + str(int(round(out.Izz_lump))))
    OutputTextFile.write('\nIxy moment [kgm^2]: '\
                         + str(int(round(out.Ixy_lump))))
    OutputTextFile.write('\nIyz moment [kgm^2]: '\
                         + str(int(round(out.Iyz_lump))))
    OutputTextFile.write('\nIxz moment [kgm^2]: '\
                         + str(int(round(out.Ixz_lump))))
    OutputTextFile.write('\n-------------------------------------------'\
                         + '----')
    OutputTextFile.write('\nZero Fuel configuration -------------------'\
                         + '----')
    OutputTextFile.write('\nRoll moment, Ixx [kgm^2]: '\
                         + str(int(round(out.Ixx_lump_zfm))))
    OutputTextFile.write('\nPitch moment, Iyy [kgm^2]: '\
                         + str(int(round(out.Iyy_lump_zfm))))
    OutputTextFile.write('\nYaw moment, Izz [kgm^2]: '\
                         + str(int(round(out.Izz_lump_zfm))))
    OutputTextFile.write('\nIxy moment [kgm^2]: '\
                         + str(int(round(out.Ixy_lump_zfm))))
    OutputTextFile.write('\nIyz moment [kgm^2]: '\
                         + str(int(round(out.Iyz_lump_zfm))))
    OutputTextFile.write('\nIxz moment [kgm^2]: '\
                         + str(int(round(out.Ixz_lump_zfm))))
    OutputTextFile.write('\n-------------------------------------------'\
                         + '----')
    OutputTextFile.write('\nZero Payload configuration ----------------'\
                         + '----')
    OutputTextFile.write('\nRoll moment, Ixx [kgm^2]: '\
                         + str(int(round(out.Ixx_lump_zpm))))
    OutputTextFile.write('\nPitch moment, Iyy [kgm^2]: '\
    ...
    OutputTextFile.write('\nIyz moment [kgm^2]: '\
                         + str(int(round(out.Iyz_lump_zpm))))
    OutputTextFile.write('\nIxz moment [kgm^2]: '\
                         + str(int(round(out.Ixz_lump_zpm))))
    OutputTextFile.write('\n-------------------------------------------'\
                         + '----')
    OutputTextFile.write('\nOEM configuration -------------------------'\
                         + '----')
    OutputTextFile.write('\nRoll moment, Ixx [kgm^2]: '\
                         + str(int(round(out.Ixx_lump_oem))))
    OutputTextFile.write('\nPitch moment, Iyy [kgm^2]: '\
    ...
    OutputTextFile.write('\nIyz moment [kgm^2]: '\
                         + str(int(round(out.Iyz_lump_oem))))
    OutputTextFile.write('\nIxz moment [kgm^2]: '\
                         + str(int(round(out.Ixz_lump_oem))))
    OutputTextFile.write('\n-------------------------------------------'\
                         + '----')
    if bi.USER_CASE:
        OutputTextFile.write('\nUser configuration --------------------'\
                             + '--------')
        OutputTextFile.write('\nRoll moment, Ixx [kgm^2]: '\
                             + str(int(round(out.Ixx_lump_user))))
        OutputTextFile.write('\nPitch moment, Iyy [kgm^2]: '\
        ...
        OutputTextFile.write('\nIyz moment [kgm^2]: '\
                             + str(int(round(out.Iyz_lump_user))))
        OutputTextFile.write('\nIxz moment [kgm^2]: '\
                             + str(int(round(out.Ixz_lump_user))))
        OutputTextFile.write('\n---------------------------------------'\
                             + '--------')
    ### Closing Text File
