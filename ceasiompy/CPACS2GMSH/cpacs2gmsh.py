...
def cpacs2gmsh(cpacs_path, cpacs_out_path):
    ...
    mesh_size_farfield = get_value_or_default(cpacs.tixi, GMSH_MESH_SIZE_FARFIELD_XPATH, 2)
    ...
    refine_factor = get_value_or_default(cpacs.tixi, GMSH_REFINE_FACTOR_XPATH, 5.0)
