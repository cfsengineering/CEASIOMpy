...
from ceasiompy.CPACS2GMSH.func.cpacs2gmsh_utils import initialize_gmsh, write_gmsh, cfg_rotors
...
def generate_gmsh(
    ...
    # The rest of children_dimtag are list of tuples (dimtag, tag) that represent volumes in the model.
