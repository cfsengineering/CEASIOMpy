...
def crew_check(range_maxpass, ri):
    ...
    if flight_time / ri.pilot_nb <= 4.00:
        log.info("No extra pilot needed, approximate flight time [hr]: " + str(flight_time))
    else:
        if flight_time < 8.00:
            ...
            log.info("Flight longer than 8 hours, approximate time [hr]: " + str(flight_time))
            ...
            log.info("Flight longer than 12 hours, approximate time [hr]: " + str(flight_time))
            log.info("Suggested extra flight crew members")
