...
def save_plots(
    ...
    Args:
        ...
        optimal_axial_interference_factor (np.ndarray): Optimal axial interference factor.
        optimal_rotational_interference_factor (np.ndarray): Optimal rotational interference factor.
