...
<<<<<<< HEAD
    ...
    deal_with_feature(aeromap, groupby_list, "altitude", alt_crit)
    deal_with_feature(aeromap, groupby_list, "machNumber", mach_crit)
    deal_with_feature(aeromap, groupby_list, "angleOfSideslip", aos_crit)
=======
    title = cpacs.ac_name
    criterion = pd.Series([True] * len(aeromap.index))
    groupby_list = ["uid", "machNumber", "altitude", "angleOfSideslip"]
