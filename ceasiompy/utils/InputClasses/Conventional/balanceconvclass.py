"""
    ...
    The script contains the user inputs required for the balance analysis.
...
class BalanceInputs:
    """
    The class contains all the input from user needed for the balance analysis.
...
class MassesWeights:
    """
    The class contains all the aircraft mass and weight values required
...
class BalanceOutputs:
    """
    The class contains all the output value of the Balance analysis.
