...
def produce_wing_output_txt(awg, NAME):
    ...
    OutputTextFile.write('\nVolume of the wing as fuselage [m^3]: '\
                         + str(awg.fuse_vol))
    OutputTextFile.write('\nVolume of the remaining portion of the wing'\
                         + ' [m^3]: ' + str(awg.wing_vol))
    OutputTextFile.write('\nFuel volume in the fuselage wing [m^3]: '\
...
def produce_geom_output_txt(afg, awg, NAME):
    ...
    OutputTextFile.write('\nPerimeter of each section of each fuselage '\
    ...
    OutputTextFile.write('\nVolume of each fuselage [m^3]: '\
                         + str(afg.fuse_vol))
    OutputTextFile.write('\nFuel Volume in each fuselage [m^3]: '
    ...
    OutputTextFile.write('\nNumber of Wings [-]: ' + str(awg.wing_nb))
    OutputTextFile.write('\nWing symmetry plane [-]: ' + str(awg.wing_sym))
    OutputTextFile.write('\nNumber of wing sections (not counting symmetry) '\
                         + '[-]: ' + str(awg.wing_sec_nb))
    OutputTextFile.write('\nNumber of wing segments (not counting symmetry) '\
                         + '[-]: ' + str(awg.wing_seg_nb))
    OutputTextFile.write('\nWingd Span [m]: ' + str(awg.wing_span))
    OutputTextFile.write('\nWing MAC length [m]: ' + str(awg.wing_mac[0,]))
    OutputTextFile.write('\nWing MAC x,y,z coordinate [m]: \n'\
