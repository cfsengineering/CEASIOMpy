...
GMSH_MESH_SIZE_BOX_INTERNAL_XPATH = GMSH_XPATH + "/mesh_size/box/internal"
GMSH_MESH_SIZE_BOX_EXTERNAL_XPATH = GMSH_XPATH + "/mesh_size/box/external"
GMSH_MESH_SIZE_BOX_THICKNESS_XPATH = GMSH_XPATH + "/mesh_size/box/thickness"
