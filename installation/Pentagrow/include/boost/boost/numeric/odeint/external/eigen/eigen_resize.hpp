...
struct is_resizeable_sfinae< Derived ,
                      typename boost::enable_if< typename boost::is_base_of< eeigen::MatrixBase< Derived > , Derived >::type >::type >
{ 
...
template < class Derived  >
struct is_resizeable_sfinae< Derived ,
                      typename boost::enable_if< typename boost::is_base_of< eeigen::ArrayBase< Derived > , Derived >::type >::type >
{ 
    typedef boost::true_type type;
    const static bool value = type::value;
};
...
struct same_size_impl_sfinae< Derived , Derived ,
                       typename boost::enable_if< typename boost::is_base_of< eeigen::MatrixBase< Derived > , Derived >::type >::type >
{
    static bool same_size( const eeigen::MatrixBase< Derived > &m1 , const eeigen::MatrixBase< Derived > &m2 )
...
struct same_size_impl_sfinae< Derived , Derived ,
                       typename boost::enable_if< typename boost::is_base_of< eeigen::ArrayBase< Derived > , Derived >::type >::type >
{
    static bool same_size( const eeigen::ArrayBase< Derived > &v1 , const eeigen::ArrayBase< Derived >  &v2 )
    {
...
struct resize_impl_sfinae< Derived , Derived ,
                    typename boost::enable_if< typename boost::is_base_of< eeigen::MatrixBase< Derived > , Derived >::type >::type >
{
    static void resize( eeigen::MatrixBase< Derived > &m1 , const eeigen::MatrixBase< Derived > &m2 )
    {
...
struct resize_impl_sfinae< Derived , Derived ,
                    typename boost::enable_if< typename boost::is_base_of< eeigen::ArrayBase< Derived > , Derived >::type >::type >
{
    static void resize( eeigen::ArrayBase< Derived > &v1 , const eeigen::ArrayBase< Derived > &v2 )
    {
