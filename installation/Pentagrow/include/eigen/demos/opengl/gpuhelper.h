...
class GpuHelper
{
  public:
    ...
    */
    template<typename Scalar, int _Flags>
    void loadMatrix(const eeigen::Matrix<Scalar,4,4, _Flags, 4,4>& mat, GLenum matrixTarget);

    template<typename Scalar, typename Derived>
    void loadMatrix(
        const eeigen::CwiseNullaryOp<eeigen::internal::scalar_identity_op<Scalar>,Derived>&,
        GLenum matrixTarget);
...
void GpuHelper::multMatrix(const Matrix<Scalar,4,4, _Flags, 4,4>& mat, GLenum matrixTarget)
{
    ...
    GlMatrixHelper<_Flags&eeigen::RowMajorBit, _Flags>::multMatrix(mat);
}
...
template<typename Scalar, int _Flags>
void GpuHelper::loadMatrix(const eeigen::Matrix<Scalar,4,4, _Flags, 4,4>& mat, GLenum matrixTarget)
{
    setMatrixTarget(matrixTarget);
    GlMatrixHelper<(_Flags&eeigen::RowMajorBit)!=0, _Flags>::loadMatrix(mat);
}
...
inline void GpuHelper::pushMatrix(const Matrix<Scalar,4,4, _Flags, 4,4>& mat, GLenum matrixTarget)
{
    ...
    GlMatrixHelper<_Flags&eeigen::RowMajorBit,_Flags>::loadMatrix(mat);
}
