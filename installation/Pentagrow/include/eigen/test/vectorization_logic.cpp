...
struct vectorization_logic
{
  ...
  static void run()
  {
    ...
    typedef Matrix<Scalar,
                   (PacketSize == 8 ? 4 : PacketSize == 4 ? 2
                                      : PacketSize == 2   ? 1
                                                          : /*PacketSize==1 ?*/ 1),
                   (PacketSize == 8 ? 2 : PacketSize == 4 ? 2
                                      : PacketSize == 2   ? 2
                                                          : /*PacketSize==1 ?*/ 1)>
        Matrix1;
    ...
    typedef Matrix<Scalar,
                   (PacketSize == 8 ? 4 : PacketSize == 4 ? 6
                                      : PacketSize == 2   ? ((Matrix11::Flags & RowMajorBit) ? 2 : 3)
                                                          : /*PacketSize==1 ?*/ 1),
                   (PacketSize == 8 ? 6 : PacketSize == 4 ? 2
    ...
    if (PacketSize > 1)
    {
      ...
      VERIFY(test_assign(Matrix<Scalar, 17, 17>(), Matrix<Scalar, 17, 17>() + Matrix<Scalar, 17, 17>(),
                         HalfPacketSize == 1 ? InnerVectorizedTraversal : EIGEN_UNALIGNED_VECTORIZE ? LinearVectorizedTraversal
                                                                                                    : LinearTraversal,
                         NoUnrolling));
...
struct vectorization_logic_half
{
  ...
  static void run()
  {
    ...
    VERIFY((test_assign<
            Map<Matrix<Scalar, EIGEN_PLAIN_ENUM_MAX(2, PacketSize), EIGEN_PLAIN_ENUM_MAX(2, PacketSize)>, AlignedMax, InnerStride<3 * PacketSize>>,
            Matrix<Scalar, EIGEN_PLAIN_ENUM_MAX(2, PacketSize), EIGEN_PLAIN_ENUM_MAX(2, PacketSize)>>(DefaultTraversal, CompleteUnrolling)));
