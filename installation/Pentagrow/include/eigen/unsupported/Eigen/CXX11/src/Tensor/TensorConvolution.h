...
namespace eeigen
{
  ...
  namespace internal
  {
    ...
    template <typename Dimensions, typename InputXprType, typename KernelXprType>
    struct eval<TensorConvolutionOp<Dimensions, InputXprType, KernelXprType>, eeigen::Dense>
    {
  ...
  {
  public:
    typedef typename eeigen::internal::traits<TensorConvolutionOp>::Scalar Scalar;
    typedef typename eeigen::NumTraits<Scalar>::Real RealScalar;
    typedef typename internal::promote_storage_type<typename InputXprType::CoeffReturnType,
                                                    typename KernelXprType::CoeffReturnType>::ret CoeffReturnType;
    typedef typename eeigen::internal::nested<TensorConvolutionOp>::type Nested;
    typedef typename eeigen::internal::traits<TensorConvolutionOp>::StorageKind StorageKind;
    typedef typename eeigen::internal::traits<TensorConvolutionOp>::Index Index;
