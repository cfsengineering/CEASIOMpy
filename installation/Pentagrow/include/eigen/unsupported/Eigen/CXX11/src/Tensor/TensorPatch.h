...
template<typename PatchDim, typename XprType>
struct eval<TensorPatchOp<PatchDim, XprType>, eeigen::Dense>
{
...
{
  public:
  typedef typename eeigen::internal::traits<TensorPatchOp>::Scalar Scalar;
  typedef typename eeigen::NumTraits<Scalar>::Real RealScalar;
  typedef typename XprType::CoeffReturnType CoeffReturnType;
  typedef typename eeigen::internal::nested<TensorPatchOp>::type Nested;
  typedef typename eeigen::internal::traits<TensorPatchOp>::StorageKind StorageKind;
  typedef typename eeigen::internal::traits<TensorPatchOp>::Index Index;
