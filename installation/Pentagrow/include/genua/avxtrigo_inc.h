...
#ifndef AVXTRIGO_INC_H
#define AVXTRIGO_INC_H
...
/*
  ...
  This version is modified to accomodate different compilers' intrinsic
  definitions in immintrin.h.
...
_PS256_CONST_TYPE(min_norm_pos, unsigned, 0x00800000);
_PS256_CONST_TYPE(mant_mask, unsigned, 0x7f800000);
_PS256_CONST_TYPE(inv_mant_mask, int, ~0x7f800000);

_PS256_CONST_TYPE(sign_mask, unsigned, 0x80000000);
_PS256_CONST_TYPE(inv_sign_mask, unsigned, ~0x80000000);
...
#ifdef TRIGO_USE_AVX2

#define DECLARE_AVXTRIG(fn)   fn##_fma
#define simd_slli_epi32       _mm256_slli_epi32
#define simd_srli_epi32       _mm256_srli_epi32

#define simd_and_si128        _mm256_and_si128
#define simd_andnot_si128     _mm256_andnot_si128
#define simd_cmpeq_epi32      _mm256_cmpeq_epi32
#define simd_sub_epi32        _mm256_sub_epi32
#define simd_add_epi32        _mm256_add_epi32

#else

#define DECLARE_AVXTRIG(fn)   fn##_avx
...
static inline v8si simd_##fn(v8si x, int a) \
{ \
...
static inline v8si simd_##fn(v8si x, v8si y) \
{ \
...
#define _mm256_and_si256     _mm256_and_si128
#define _mm256_andnot_si256  _mm256_andnot_si128

#endif /* TRIGO_USE_AVX2 */

/* natural logarithm computed for 8 simultaneous float
   return NaN for x <= 0
*/
inline v8sf DECLARE_AVXTRIG(log256_ps)(const v8sf &x_)
{
  v8si imm0;
  v8sf x(x_), one = *(v8sf*)_ps256_1;
  ...
  imm0 = simd_srli_epi32(_mm256_castps_si256(x), 23);
  ...
  imm0 = simd_sub_epi32(imm0, *(v8si*)_pi32_256_0x7f);
...
inline v8sf DECLARE_AVXTRIG(exp256_ps)(const v8sf &x_)
{
  ...
  imm0 = simd_add_epi32(imm0, *(v8si*)_pi32_256_0x7f);
  imm0 = simd_slli_epi32(imm0, 23);
...
*/
inline v8sf DECLARE_AVXTRIG(sin256_ps)(const v8sf &x_)
{
  v8sf x(x_), xmm1, xmm2 = _mm256_setzero_ps(), xmm3, sign_bit, y;
  v8si imm0, imm2;

#ifndef TRIGO_USE_AVX2
  v4si imm0_1, imm0_2;
  v4si imm2_1, imm2_2;
#endif
...
inline v8sf DECLARE_AVXTRIG(cos256_ps)(const v8sf &x_) { // any x
  v8sf x(x_), xmm1, xmm2 = _mm256_setzero_ps(), xmm3, y;
  v8si imm0, imm2;
...
inline void DECLARE_AVXTRIG(sincos256_ps)(const v8sf &x_, v8sf *s, v8sf *c)
{
  v8sf x(x_), xmm1, xmm2, xmm3 = _mm256_setzero_ps(), sign_bit_sin, y;
  v8si imm0, imm2, imm4;
