...
#define JU_LEASTBYTESMASK(BYTES) \
        ((JU_WORD_LIT(0x100UL) << (cJU_BITSPERBYTE * ((BYTES) - 1))) - 1)
...
#ifndef JU_WORD_LIT
#define JU_WORD_LIT(x)   ((uintptr_t) (x))
#endif
...
#endif
{
        ...
        word = (word & JU_WORD_LIT(0x5555555555555555)) + ((word & JU_WORD_LIT(0xAAAAAAAAAAAAAAAA)) >> 1);
        word = (word & JU_WORD_LIT(0x3333333333333333)) + ((word & JU_WORD_LIT(0xCCCCCCCCCCCCCCCC)) >> 2);
        word = (word & JU_WORD_LIT(0x0F0F0F0F0F0F0F0F)) + ((word & JU_WORD_LIT(0xF0F0F0F0F0F0F0F0)) >> 4);
#if defined(BITMAP_LEAF16x16) || defined(BITMAP_LEAF32x8) || defined(BITMAP_LEAF64x4)
        word = (word & JU_WORD_LIT(0x00FF00FF00FF00FF)) + ((word & JU_WORD_LIT(0xFF00FF00FF00FF00)) >> 8);
#endif
#if defined(BITMAP_LEAF32x8) || defined(BITMAP_LEAF64x4)
        word = (word & JU_WORD_LIT(0x0000FFFF0000FFFF)) + ((word & JU_WORD_LIT(0xFFFF0000FFFF0000)) >>16);
#endif
#ifdef BITMAP_LEAF64x4
        word = (word & JU_WORD_LIT(0x00000000FFFFFFFF)) + ((word & JU_WORD_LIT(0xFFFFFFFF00000000)) >>32);
#endif
#endif // JU_64BIT
...
#define JU_BITPOSMASKB(BITNUM) (((intptr_t) 1L) << ((BITNUM) % cJU_BITSPERSUBEXPB))
#define JU_BITPOSMASKL(BITNUM) (((intptr_t) 1L) << ((BITNUM) % cJU_BITSPERSUBEXPL))
