...
#define cJU_MASKATSTATE(State)  (((intptr_t) 0xffL) << (((State) - 1) * cJU_BITSPERBYTE))
...
#endif
{
        ...
        *PoIndex = (((intptr_t)91L) << 56) | (((intptr_t)92L) << 48) | (((intptr_t)93L) << 40) | (((intptr_t)94L) << 32)
                 | (((intptr_t)95L) << 24) | (((intptr_t)96L) << 16) | (((intptr_t)97L) <<  8) |  ((intptr_t)98L);
