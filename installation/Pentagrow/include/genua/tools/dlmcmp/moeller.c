...
static void isect2(double VTX0[3],double VTX1[3],double VTX2[3],double VV0,double VV1,double VV2,
...
static int compute_intervals_isectline(double VERT0[3],double VERT1[3],double VERT2[3],
