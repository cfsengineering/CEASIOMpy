...
/*
static inline int _check_min_max(const double p1[], const double q1[],
                                const double r1[], const double p2[],
                                const double q2[], const double r2[] ) 
{
  double v1[3], v2[3], N1[3];
...
#define CHECK_MIN_MAX(p1,q1,r1,p2,q2,r2)  \
        return _check_min_max(p1,q1,r1,p2,q2,r2);
...
static inline int _tri_tri_3d(const double p1[], const double q1[],
                              const double r1[], const double p2[],
                              const double q2[], const double r2[],
...
{ 
  if (dp2 > 0.0f) { 
     if (dq2 > 0.0f) 
       return _check_min_max(p1,r1,q1,r2,p2,q2); 
     else if (dr2 > 0.0f) 
       return _check_min_max(p1,r1,q1,q2,r2,p2);
     else 
       return _check_min_max(p1,q1,r1,p2,q2,r2);
  }
  else if (dp2 < 0.0f) { 
    if (dq2 < 0.0f) 
      return _check_min_max(p1,q1,r1,r2,p2,q2);
    else if (dr2 < 0.0f) 
      return _check_min_max(p1,q1,r1,q2,r2,p2);
    else 
      return _check_min_max(p1,r1,q1,p2,q2,r2);
  } else { 
    if (dq2 < 0.0f) { 
      if (dr2 >= 0.0f)  
        return _check_min_max(p1,r1,q1,q2,r2,p2);
...
#define TRI_TRI_3D(p1,q1,r1,p2,q2,r2,dp2,dq2,dr2)  \
        return _tr_tri_3d(p1,q1,r1,p2,q2,r2,dp2,dq2,dr2);
                            ...
                            const double p2[3], const double q2[3], const double r2[3])
{
  ...
  // replaced with robust predicates 
  // dp1 = -jrsOrient3d(p2, q2, r2, p1);
  // dq1 = -jrsOrient3d(p2, q2, r2, q1);
  // dr1 = -jrsOrient3d(p2, q2, r2, r1);
...
static int ccw_tri_tri_intersection_2d(const double p1[2], const double q1[2], const double r1[2], 
