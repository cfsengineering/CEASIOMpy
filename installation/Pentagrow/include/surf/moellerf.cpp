 ...
 * isectpt1[3],float isectpt2[3]); coplanar returns whether the tris are
 * coplanar isectpt1, isectpt2 are the endpoints of the line of intersection
 */

#include "guige.h"
#include <cmath>

#define FABS(x) ((float) fabsf(x)) /* implement as is fastest on your machine   \
                                   */
...
static int coplanar_tri_tri(float N[3], const float V0[3], const float V1[3],
...
static void isect2(float VTX0[3], float VTX1[3], float VTX2[3], float VV0,
...
static int compute_intervals_isectline(float VERT0[3], float VERT1[3],
