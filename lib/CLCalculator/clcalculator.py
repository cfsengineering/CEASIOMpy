...
def calculate_cl(ref_area, alt, mach, mass, load_fact = 1.05):
    ...
    Source : Small demonstration can be found in:
...
def get_cl(cpacs_path,cpacs_out_path):
    ...
    tixi, cruise_alt = get_value_or_default(tixi,cruise_alt_xpath,11000.0)
    ...
    tixi, cruise_speed = get_value_or_default(tixi,cruise_speed_xpath,230.0)
