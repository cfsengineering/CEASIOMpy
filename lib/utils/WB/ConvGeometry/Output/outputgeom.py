...
def produce_output_txt(ag, NAME):
    ...
    OutputTextFile.write('\nFuse nose Length [m]: '\
                         + str(np.around(ag.fuse_nose_length,5)))
    OutputTextFile.write('\nFuse cabin Length [m]: '\
                         + str(np.around(ag.fuse_cabin_length,5)))
    OutputTextFile.write('\nFuse tail Length [m]: '\
                         + str(np.around(ag.fuse_tail_length,5)))
    OutputTextFile.write('\nAircraft Length [m]: '\
                         + str(np.around(ag.tot_length,5)))
    ...
    OutputTextFile.write('\nMean fuselage width [m]: '\
                         + str(np.around(ag.fuse_mean_width,5)))
    ...
    OutputTextFile.write('\nVolume of the cabin [m^3]: '\
                         + str(np.around(ag.fuse_cabin_vol,5)))
    OutputTextFile.write('\nVolume of the fuselage [m^3]: '\
                         + str(np.around(ag.fuse_vol,5)))
    OutputTextFile.write('\n')
    OutputTextFile.write('\n-------------------------------------------------')
    OutputTextFile.write('\nWINGS -------------------------------------------')
    OutputTextFile.write('\n-------------------------------------------------')
    ...
    OutputTextFile.write('\nMain wing planform area [m^2]: '\
                         + str(np.around(ag.wing_plt_area_main,5)))
