...
:: ==============================
:: Windows launcher for CEASIOMpy
:: ==============================
::
:: ----------------------------------------------------------------------
...
:: ----------------------------------------------------------------------
::
:: Adapted from PyTornado script written by Aaron Dettmann
::
:: This BAT file allows CEASIOMpy to be run from the Windows command
