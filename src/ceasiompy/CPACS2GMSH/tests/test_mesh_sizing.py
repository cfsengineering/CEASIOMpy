...
from ceasiompy.CPACS2GMSH.func.mesh_sizing import fuselage_cpacs_size, wings_cpacs_size
...
def test_wing_size():
    ...
    wing_maxlen, wing_minlen = wings_cpacs_size(CPACS(CPACS_IN_PATH))
